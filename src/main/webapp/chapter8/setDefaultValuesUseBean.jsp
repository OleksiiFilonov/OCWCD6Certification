...
<body>
	<div id="container">
		<jsp:useBean id="employee" type="com.example.chapter8.Person" class="com.example.chapter8.Employee" scope="request">
			<h1>If bean doesn't created before set default values</h1>
			<jsp:setProperty name="employee" property="firstName" value="Default First Name"/>
			<jsp:setProperty name="employee" property="lastName" value="Default Last Name"/>
