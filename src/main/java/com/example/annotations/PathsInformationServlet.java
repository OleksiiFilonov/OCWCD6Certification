...
@WebServlet(description = "This is just a servlet to display Context path and Context value", urlPatterns = {
		"/informationServlet", "/informationServlet2", "*.info" }, displayName = "PathsInformationServlet servlet Display Name", name = "PathsInformation")
public class PathsInformationServlet extends HttpServlet {
	...
	public void doGet(final HttpServletRequest request, final HttpServletResponse response) throws ServletException,
		...
		writer.println(String.format("<h1>Server Info getServletContext().getServerInfo() : \"%s\"</h1>",
				getServletContext().getServerInfo()));
		writer.println(String.format("<h1>Servlet Info getServletInfo() : \"%s\"</h1>", getServletInfo()));
